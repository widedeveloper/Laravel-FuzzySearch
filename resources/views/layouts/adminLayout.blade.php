...
<head>
  ...
  <title>Admin_IPBud.com | Dashboard</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{$user ? 'active' : ''}}">
          ...
          <ul class="treeview-menu {{$user ? 'menu-open' : ''}}">
            <li @if($menu_name == 'roles') class="active" @endif><a href="{{url('/admin/roles')}}"><i class="fa fa-circle-o"></i> Roles</a></li>
            <li @if($menu_name == 'users') class="active" @endif><a href="{{url('/admin/users')}}"><i class="fa fa-circle-o"></i> Users</a></li>
          </ul>
        </li>
        @endif
      </ul>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="http://IPBud.org">Search</a>.</strong> All rights
    reserved.
  </footer>
